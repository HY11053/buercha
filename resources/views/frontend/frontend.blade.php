...
<div class="footer_nav">
    <div class="box"> <a href="/" title="不二茶铺加盟">网站首页</a> <a href="/{{\App\AdminModel\Arctype::where('id',2)->value('real_path')}}/"  title="{{\App\AdminModel\Arctype::where('id',2)->value('typename')}}">{{\App\AdminModel\Arctype::where('id',2)->value('typename')}}</a> <a href="/{{\App\AdminModel\Arctype::where('id',3)->value('real_path')}}/"  title="{{\App\AdminModel\Arctype::where('id',3)->value('typename')}}">{{\App\AdminModel\Arctype::where('id',3)->value('typename')}}</a> <a href="/{{\App\AdminModel\Arctype::where('id',9)->value('real_path')}}/"  title="{{\App\AdminModel\Arctype::where('id',9)->value('typename')}}">{{\App\AdminModel\Arctype::where('id',9)->value('typename')}}</a> <a href="/map/"  title="网站地图">网站地图</a> </div>
</div>
<div class="footer">
    <div class="box">
        <div class="clearfix">
